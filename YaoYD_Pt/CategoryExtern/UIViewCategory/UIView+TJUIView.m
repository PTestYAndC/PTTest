...
@implementation UIView (TJUIView)
- (CGFloat)left {
...
-(void)setCornerRadius:(BOOL)isRadius borderWidth:(CGFloat)width borderColor:(UIColor*)borderColor
{
    self.layer.masksToBounds = YES;
    if (isRadius) {
        self.layer.cornerRadius  = self.frame.size.width/2.0;
...
-(void)setCornerWidthRadius:(CGFloat)width borderWidth:(CGFloat)bordWidth borderColor:(UIColor*)borderColor
{
    self.layer.masksToBounds = YES;
    self.layer.cornerRadius  = width;
