...
#define COCOAPODS_VERSION_MINOR_SloppySwiper 5
#define COCOAPODS_VERSION_PATCH_SloppySwiper 0

// YYKit
#define COCOAPODS_POD_AVAILABLE_YYKit
#define COCOAPODS_VERSION_MAJOR_YYKit 0
#define COCOAPODS_VERSION_MINOR_YYKit 2
#define COCOAPODS_VERSION_PATCH_YYKit 0

// YYKit/no-arc
#define COCOAPODS_POD_AVAILABLE_YYKit_no_arc
#define COCOAPODS_VERSION_MAJOR_YYKit_no_arc 0
#define COCOAPODS_VERSION_MINOR_YYKit_no_arc 2
#define COCOAPODS_VERSION_PATCH_YYKit_no_arc 0

// wax
#define COCOAPODS_POD_AVAILABLE_wax
#define COCOAPODS_VERSION_MAJOR_wax 1
#define COCOAPODS_VERSION_MINOR_wax 0
#define COCOAPODS_VERSION_PATCH_wax 0
